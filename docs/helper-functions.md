...
- [KudoJS Helper Functions](#kudojs-helper-functions) - [`kudoJS.id`](#kudojsid) - [`kudoJS.once`](#kudojsonce) - [`kudoJS.curry`](#kudojscurry) - [`kudoJS.ocurry`](#kudojsocurry) - [`kudoJS.compose`](#kudojscompose) - [`kudoJS.constant`](#kudojsconstant) - [`kudoJS.fmap`](#kudojsfmap) - [`kudoJS.assoc`](#kudojsassoc) - [`kudoJS.bimap`](#kudojsbimap) - [`kudoJS.chain`](#kudojschain) - [`kudoJS.caseOf`](#kudojscaseof) - [`kudoJS.liftAn`](#kudojsliftan) - [`kudoJS.liftA2`](#kudojslifta2) - [`kudoJS.liftA3`](#kudojslifta3) - [`kudoJS.liftA4`](#kudojslifta4) - [`kudoJS.liftA5`](#kudojslifta5) - [`kudoJS.when`](#kudojswhen) - [`kudoJS.prop`](#kudojsprop) - [`kudoJS.pick`](#kudojspick) - [`kudoJS.eitherToMaybe`](#kudojseithertomaybe) - [`kudoJS.maybeToEither`](#kudojsmaybetoeither)
